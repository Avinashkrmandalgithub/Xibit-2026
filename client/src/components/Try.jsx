...
function Try() {
  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6] text-slate-900">
      <div
        className={
          showApiModal ? "pointer-events-none select-none blur-sm" : ""
        }
      >
        ...
        <main className="mx-auto flex h-[calc(100vh-64px)] max-w-3xl flex-col px-4 sm:px-6">
          ...
          <div className="flex-1 overflow-y-auto py-6 space-y-4 scrollbar-hide">
            {messages.map((msg) => (
              ...
              >
                {msg.role === "assistant" && (
                  <div className="mt-1 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-linear-to-br from-[#8FA6F8] to-[#D16BA5] shadow-sm">
                    <svg
                ...
                {msg.role === "user" && (
                  <div className="mt-1 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-slate-200 text-xs font-semibold text-slate-600 shadow-sm">
                    U
                  </div>
                )}
              </div>
            ...
            {isThinking && (
              <div className="flex gap-3 justify-start">
                ...
                <div className="rounded-2xl rounded-tl-sm border border-[#8FA6F8]/15 bg-linear-to-br from-[#8FA6F8]/12 to-[#D16BA5]/8 px-4 py-3.5">
          ...
          <div className="pb-5 pt-2">
            <div className="relative rounded-2xl border border-slate-200 bg-white shadow-md transition-all focus-within:shadow-lg focus-within:border-[#8FA6F8]/40">
              <textarea
                ref={textareaRef}
                value={input}
      ...
      {showApiModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-[0_32px_80px_-16px_rgba(15,23,42,0.28)]">
            <div className="h-1 w-full bg-linear-to-r from-[#8FA6F8] via-[#D16BA5] to-[#F97316]" />
            <div className="px-7 pt-7 pb-2">
              <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-2xl bg-linear-to-br from-[#8FA6F8]/20 to-[#D16BA5]/15">
                <svg
                  className="h-6 w-6 text-[#8FA6F8]"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <p className="mt-1.5 text-sm text-slate-500">
                Paste your Rag Flow API key to unlock the chat workspace.
              </p>
            </div>
            <div className="px-7 py-5">
              ...
              <button
                ...
                className="mt-3 w-full rounded-2xl bg-linear-to-r from-[#8FA6F8] to-[#D16BA5] py-3 text-sm font-semibold text-white shadow-sm transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40"
              >
                Unlock Workspace
              </button>
            </div>
            <div className="px-7 pb-6">
              <p className="text-center text-xs text-slate-400">
                ...
                <a
                  href="/upload"
                  className="font-medium text-[#8FA6F8] hover:underline"
                >
                  Generate one on the Upload page
                </a>
              </p>
            </div>
          </div>
